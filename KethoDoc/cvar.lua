...
m.cvar_cache = {
	var = {
		...
		["ActionButtonUseKeyHeldSpell"] = {"0", 4, true, false, "Activate the press and hold cast option on a keydown"},
		...
		["AdvFlyingDynamicFOVEnabled"] = {"1", 4, false, false, "Enables adjustment of camera field of view based on gliding speed"},
		...
		["calendarShowResets"] = {"0", 4, false, true, "Whether raid resets should appear in the calendar"},
		...
		["cameraFov"] = {"90", 1, false, false, "Default camera field of view"},
		...
		["CMAA2HalfFloat"] = {"0", 1, false, false, "0: 32-bit Float. 1: 16-bit Float."},
		["CMAA2Quality"] = {"3", 1, false, false, "CMAA2 Quality Level. 0 - LOW, 1 - MEDIUM, 2 - HIGH, 3 - ULTRA"},
		...
		["combinedBags"] = {"0", 4, true, false, "Use combined bag frame for all bags"},
		...
		["DisableAdvancedFlyingVelocityVFX"] = {"0", 4, true, false, "Disable the advanced flying velocity VFX"},
		...
		["dragonRidingPitchSensitivity"] = {"2.5", 4, false, false, "Changes the sensitivity of pitch down/up keys"},
		["dragonRidingTurnSensitivity"] = {"5", 4, false, false, "Changes the sensitivity of turn left/right keys"},
		...
		["DynamicVRSSensitivityThreshold"] = {"0", 1, false, false, "Enable dynamic sensitivity threshold based on target FPS for VRS"},
		...
		["EJSelectedTier"] = {"0", 4, false, true, "Stores the last manually selected journal tier in the encounter journal"},
		...
		["EmpowerMinHoldStagePercent"] = {"1.000000", 4, true, false, "Sets a percentage of the first empower stage [0.0,1.0]. Before this point, the spell will be auto-held. After it, releases will be accepted."},
		["empowerTapControls"] = {"0", 4, false, true, "By default, Empower spells use a press-hold-release control scheme. Set this CVar to use a tap-tap scheme instead."},
		["EmpowerTapControlsReleaseThreshold"] = {"300", 4, true, false, "Sets the time in milliseconds after which release/re-hold requests will be registered for press-and-tap empowers. Begins when the cast is sent from the client."},
		...
		["enableSourceLocationLookup"] = {"1", 0, false, false, "Allows addon file name lookup for debugging help"},
		...
		["engineSurvey"] = {"0", 4, false, false, "Whether to send the engine survey to the servers"},
		...
		["expandBagBar"] = {"1", 4, true, false, "Expand the main menu bar that shows the bags so you can see all equipped bags instead of just the backpack and reagent bag"},
		...
		["ForceGenerateSlug"] = {"0", 0, false, false, "Generate .slug files for all loaded fonts before they are actually used rather than deferred load."},
		...
		["fstack_enabled"] = {"0", 0, false, false, "0: Hide Framestack Tooltip (Default), 1: Show Framestack Tooltip."},
		...
		["GameDataVisualizer"] = {"0", 5, false, false, ""},
		...
		["GamePadOverlapMouseMs"] = {"2000", 5, false, false, "Duration after gamepad+mouse input to switch to just one or the other."},
		["GamePadRunThreshold"] = {"0.5", 5, false, false, "0-1 Amount of stick movement before character transitions from walk to run"},
		...
		["graphicsComputeEffects"] = {"3", 5, false, false, ""},
		["graphicsDepthEffects"] = {"3", 1, false, false, "UI value of the graphics setting"},
		...
		["graphicsSpellDensity"] = {"4", 5, false, false, "UI value of the graphics setting"},
		["graphicsSSAO"] = {"3", 5, false, false, "UI value of the graphics setting"},
		["graphicsTextureResolution"] = {"2", 5, false, false, "UI value of the graphics setting"},
		["graphicsViewDistance"] = {"6", 1, false, false, "UI value of the graphics setting"},
		...
		["GxAllowCachelessShaderMode"] = {"0", 1, false, false, "CPU memory saving mode, if supported by backend. When enabled, shaders are fetched from disk as needed instead of being kept resident. This mode may slightly increase the time objects take to appear the first time they are encountered. Computers without solid state drives may want to disable this feature"},
		...
		["interactKeyWarningTutorial"] = {"0", 4, false, false, "Has the player seen the interact key warning tutorial since they have logged in"},
		["interactOnLeftClick"] = {"1", 4, true, false, "Test CVar for interacting with NPC's on left click"},
		["interactQuestItems"] = {"1", 4, true, false, "Enable Quest Item use as an interaction"},
		...
		["lastRenownForMajorFaction2503"] = {"0", 4, false, true, "Stores the Maruuk Centaur renown when Renown UI is closed"},
		["lastRenownForMajorFaction2507"] = {"0", 4, false, true, "Stores the Dragonscale Expedition renown when Renown UI is closed"},
		["lastRenownForMajorFaction2510"] = {"0", 4, false, true, "Stores the Valdrakken Accord renown when Renown UI is closed"},
		["lastRenownForMajorFaction2511"] = {"0", 4, false, true, "Stores the Iskaara Tuskarr renown when Renown UI is closed"},
		...
		["LowLatencyMode"] = {"0", 1, false, false, "0=None, 1=BuiltIn, 2=Reflex"},
		["luaErrorExceptions"] = {"1", 4, false, false, "Enable exceptions for non-tainted lua errors"},
		...
		["maxFPS"] = {"120", 1, false, false, "Set FPS limit"},
		["maxFPSBk"] = {"30", 1, false, false, "Set background FPS limit"},
		["maxFPSLoading"] = {"10", 1, false, false, "Set loading screen max FPS"},
		["maxLevelSpecsUsed"] = {"0", 4, false, true, "The specs the player has switched to at max level"},
		...
		["minimapTrackedInfov3"] = {"1006319", 4, false, true, "Stores the minimap tracking that was active last session."},
		["minimapTrackingClosestOnly"] = {"1", 4, false, false, "If enabled, show only the closest tracked icon for certain minimap icon types."},
		["minimapTrackingShowAll"] = {"0", 4, false, false, "If enabled, show dropdown for configuring all possible minimap tracking options."},
		...
		["motionSicknessFocalCircle"] = {"0", 4, true, false, "Enables a focal circle showing up when mounted"},
		["motionSicknessLandscapeDarkening"] = {"0", 4, true, false, "Enables landscape darkening at higher speeds"},
		...
		["nameplateHideHealthAndPower"] = {"0", 4, false, true, ""},
		...
		["nameplatePlayerLargerScale"] = {"1.8", 1, false, true, "An additional scale modifier for players."},
		["nameplatePlayerMaxDistance"] = {"", 1, false, true, "The max distance to show player nameplates."},
		...
		["nameplateShowFriendlyBuffs"] = {"0", 4, false, true, ""},
		...
		["nameplateShowPersonalCooldowns"] = {"0", 4, false, true, ""},
		...
		["outlineSoftInteractFadeDuration"] = {"0.3", 0, false, false, ""},
		...
		["perksActivitiesCurrentMonth"] = {"0", 4, true, false, "Current month for perks activities"},
		["perksActivitiesLastPoints"] = {"0", 4, true, false, "Last seen number of influence points in the perks progress bar"},
		["perksActivitiesPendingCompletion"] = {"", 4, true, false, "List of completed activities that are pending completion animation in the UI"},
		...
		["playIntroMovie"] = {"0", 4, false, false, "Starting expansion movie to play on startup"},
		...
		["professionAccessorySlotsExampleShown"] = {"0", 4, false, true, "If the profession gear slots example has been shown"},
		["professionsAllocateBestQualityReagents"] = {"1", 4, true, false, "Indicates if best quality reagents should be automatically allocated in the crafting UI."},
		["professionsAllocateBestQualityReagentsCustomer"] = {"1", 4, true, false, "Indicates if best quality reagents should be automatically allocated in the customer crafting order UI."},
		["professionsFlyoutHideUnowned"] = {"0", 4, false, true, "Boolean indicating if unowned items are hidden in the profession slot flyouts"},
		["professionsOrderDurationDropdown"] = {"2", 4, true, false, "The previously selected duration index in the professions customer order form dropdown"},
		["professionsOrderRecipientDropdown"] = {"1", 4, true, false, "The previously selected order recipient index in the professions customer order form dropdown"},
		["professionToolSlotsExampleShown"] = {"0", 4, false, true, "If the profession gear slots example has been shown"},
		...
		["raidFramesDisplayDebuffs"] = {"1", 4, false, true, "Whether to display debuffs on Raid Frames"},
		["raidFramesDisplayIncomingHeals"] = {"1", 4, false, true, "Whether to display incoming heals on Raid Frames"},
		...
		["raidGraphicsComputeEffects"] = {"3", 5, false, false, ""},
		["raidGraphicsDepthEffects"] = {"3", 5, false, false, "UI value of the raidGraphics setting"},
		...
		["raidGraphicsOutlineMode"] = {"2", 5, false, false, "UI value of the raidGraphics setting"},
		["raidGraphicsParticleDensity"] = {"4", 5, false, false, "UI value of the raidGraphics setting"},
		["raidGraphicsProjectedTextures"] = {"1", 5, false, false, "UI value of the raidGraphics setting"},
		["RAIDgraphicsQuality"] = {"6", 5, false, false, "save for Raid Graphics Quality Selection"},
		["raidGraphicsShadowQuality"] = {"3", 5, false, false, "UI value of the raidGraphics setting"},
		["raidGraphicsSpellDensity"] = {"4", 5, false, false, "UI value of the raidGraphics setting"},
		["raidGraphicsSSAO"] = {"3", 5, false, false, "UI value of the raidGraphics setting"},
		["raidGraphicsTextureResolution"] = {"2", 5, false, false, "UI value of the raidGraphics setting"},
		["raidGraphicsViewDistance"] = {"6", 5, false, false, "UI value of the raidGraphics setting"},
		...
		["RAIDshadowTextureSize"] = {"1024", 1, false, false, "Shadow texture size (1024-2048)"},
		...
		["RAIDterrainLodDist"] = {"400", 1, false, false, "Raid Terrain level of detail distance"},
		["RAIDTerrainLodDiv"] = {"768", 5, false, false, ""},
		["RAIDterrainMipLevel"] = {"0", 1, false, false, "Terrain blend map mip level"},
		["RAIDVolumeFog"] = {"0", 1, false, false, "Volume Fog"},
		...
		["reloadUIOnAspectChange"] = {"0", 1, false, false, "Reload the UI on aspect change"},
		...
		["ResolvedSSAOType"] = {"0", 1, false, false, ""},
		...
		["shadowTextureSize"] = {"1024", 1, false, false, "Shadow texture size (1024-2048)"},
		...
		["SlugOpticalWeight"] = {"0", 0, false, false, "When rendering, coverage values are remapped to increase the optical weight of the glyphs. This can improve the appearance of small text, but usually looks good only for dark text on a light background."},
		["SlugSupersampling"] = {"1", 0, false, false, "The slug glyph shader performs adaptive supersampling for high-quality rendering at small font sizes"},
		...
		["SoftTargetEnemy"] = {"1", 4, false, true, "Sets when enemy soft targeting should be enabled. 0=off, 1=gamepad, 2=KBM, 3=always"},
		["SoftTargetEnemyArc"] = {"2", 4, false, true, "0 = No yaw arc allowance, must be directly in front. 1 = Must be in front yaw arc. 2 = Can be anywhere in tab targeting area."},
		["SoftTargetEnemyRange"] = {"45.000000", 4, false, true, "Max range to soft target enemies (limited to tab targeting range)"},
		["SoftTargetForce"] = {"1", 4, false, false, "Auto-set target to match soft target. 1 = for enemies, 2 = for friends"},
		["SoftTargetFriend"] = {"0", 4, false, true, "Sets when friend soft targeting should be enabled. 0=off, 1=gamepad, 2=KBM, 3=always"},
		["SoftTargetFriendArc"] = {"2", 4, false, true, "0 = No yaw arc allowance, must be directly in front. 1 = Must be in front yaw arc. 2 = Can be anywhere in targeting area."},
		["SoftTargetFriendRange"] = {"45.000000", 4, false, true, "Max range to soft target friends (limited to tab targeting range)"},
		["SoftTargetIconEnemy"] = {"0", 4, true, false, "Show icon for soft enemy target"},
		["SoftTargetIconFriend"] = {"0", 4, true, false, "Show icon for soft friend target"},
		["SoftTargetIconGameObject"] = {"0", 4, true, false, "Show icon for sot interact game objects (interactable objects you cannot normally target)"},
		["SoftTargetIconInteract"] = {"1", 4, true, false, "Show icon for soft interact target"},
		["SoftTargetInteract"] = {"1", 4, true, false, "Sets when soft interact should be enabled. 0=off, 1=gamepad, 2=KBM, 3=always"},
		["SoftTargetInteractArc"] = {"0", 4, true, false, "0 = No yaw arc allowance, must be directly in front. 1 = Must be in front yaw arc. 2 = Can be anywhere in targeting area."},
		["softTargetInteractionTutorialTotalInteractions"] = {"0", 4, false, false, "total interactions that the player has used in soft targetting"},
		["SoftTargetInteractRange"] = {"10.000000", 4, true, false, "Max range to soft target interacts (limited to tab targeting and individual interact ranges)"},
		["SoftTargetInteractRangeIsHard"] = {"0", 4, true, false, "Sets if it should be a hard range cutoff, even for something you can interact with right now."},
		["SoftTargetLowPriorityIcons"] = {"0", 4, true, false, "Show interact icons even when there is other visual indicators, such as quest or loot effects"},
		["SoftTargetMatchLocked"] = {"1", 4, false, false, "Match appropriate soft target to locked target. 1 = hard locked target only, 2 = for targets you attack"},
		["SoftTargetNameplateEnemy"] = {"1", 4, true, false, "Always show nameplates for soft enemy target"},
		["SoftTargetNameplateFriend"] = {"0", 4, true, false, "Always show nameplates for soft friend target"},
		["SoftTargetNameplateInteract"] = {"0", 4, true, false, "Always show nameplates for soft interact target"},
		["SoftTargetNameplateSize"] = {"19", 4, true, false, "Size of soft target icon on nameplate (0 to disable)"},
		["softTargettingInteractKeySound"] = {"0", 4, true, false, "Setting for soft targeting that enables sound cues"},
		["SoftTargetTooltipDurationMs"] = {"2000", 4, true, false, ""},
		["SoftTargetTooltipEnemy"] = {"0", 4, true, false, ""},
		["SoftTargetTooltipFriend"] = {"0", 4, true, false, ""},
		["SoftTargetTooltipInteract"] = {"0", 4, true, false, ""},
		["SoftTargetTooltipLocked"] = {"0", 4, true, false, ""},
		["SoftTargetWithLocked"] = {"1", 4, false, false, "Allows soft target selection while player has a locked target. 2 = always do soft targeting"},
		["SoftTargetWorldtextFarDist"] = {"40.000000", 4, true, false, ""},
		["SoftTargetWorldtextNearDist"] = {"4.000000", 4, true, false, ""},
		["SoftTargetWorldtextNearScale"] = {"1.000000", 4, true, false, ""},
		["SoftTargetWorldtextSize"] = {"32.000000", 4, true, false, ""},
		...
		["Sound_AmbienceVolume"] = {"0.6", 7, false, false, "Ambience Volume (0.0 to 1.0)"},
		...
		["Sound_MusicVolume"] = {"0.4", 7, false, false, "music volume (0.0 to 1.0)"},
		...
		["TargetAutoEnemy"] = {"1", 4, false, true, "Auto-Target from your single target helpful spells"},
		["TargetAutoFriend"] = {"1", 4, false, true, "Auto-Target from your single target helpful spells"},
		["TargetEnemyAttacker"] = {"1", 4, false, true, "Auto-Target Enemy when they attack you"},
		["targetFPS"] = {"60", 1, false, false, "Set target FPS. Dynamic actions will be taken if you fall below the FPS target"},
		...
		["terrainLodDist"] = {"400", 1, false, false, "Terrain level of detail distance"},
		...
		["textureErrorColors"] = {"1", 1, false, false, "If enabled, replaceable textures that aren't specified will be purple"},
		...
		["trackedPerksActivities"] = {"", 4, false, true, "Internal cvar for saving tracked perks activities in order"},
		["trackedProfessionRecipes"] = {"", 4, false, true, "Internal cvar for saving tracked recipes in order"},
		["trackedProfessionRecraftRecipes"] = {"", 4, false, true, "Internal cvar for saving tracked recraft recipes in order"},
		...
		["uieditor_enabled"] = {"0", 0, false, false, "0: Hide UI Editor (default), 1: Show UI Editor."},
		...
		["unlockedExpansionLandingPages"] = {"", 4, false, true, "Bitfield for which expansion landing pages have been unlocked/seen by the user"},
		["unlockedMajorFactions"] = {"", 4, false, true, "Internal cvar for tracking unlocked Major Factions. Used to play a toast when a new faction has been unlocked."},
		...
		["UseKeyHeldSpellErrorPollTime"] = {"500", 4, true, false, "(Internal only) Time between a failed cast and when it should attempt to cast again in ms. (Clamped to 100 and 10000)"},
		["useMaxFPS"] = {"0", 1, false, false, "Enables or disables FPS limit"},
		["useMaxFPSBk"] = {"1", 1, false, false, "Enables or disables background FPS limit"},
		["UseSlug"] = {"1", 0, false, false, "Render with slug text"},
		["useTargetFPS"] = {"1", 1, false, false, "Enables or disables background FPS limit"},
		["useUiScale"] = {"0", 4, false, false, "Whether or not the UI scale should be used"},
		["validateFrameXML"] = {"1", 5, false, false, "Display warning when FrameXML detects unparsed elements"},
		...
		["volumeFog"] = {"0", 1, false, false, "Volume Fog"},
		["volumeFogInterior"] = {"1", 1, false, false, "Volume Fog Interiors"},
		["volumeFogLevel"] = {"2", 1, false, false, "Volume Fog Level (0-3)"},
		["vrsParticles"] = {"1x1", 1, false, false, "Render scale like effect for particles. Only used if lots of particles are on screen"},
		["vrsWorldGeo"] = {"1x1", 1, false, false, "Render scale like effect for terrain, buildings and liquids"},
		...
		["WorldTextMinAlpha"] = {"0.5", 4, true, false, ""},
		["WorldTextMinSize"] = {"0", 4, true, false, ""},
